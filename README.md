...
An end-to-end data project identifying the highest-value U.S. cities for entry-level data analysts, built to answer a question most people in the field actually have when they're starting out: where should I go?
...
<br>
Tools
LayerToolsData collectionU.S. Census Bureau, OpenCrime, Salary.comCleaning and mergingPython (pandas), ExcelFeature engineeringPython (pandas), ExcelVisualizationTableau Public
<br>
